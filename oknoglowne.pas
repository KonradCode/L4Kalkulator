...
var
  pensjaBrutto,pensjaBruttoRok,dodatekBrutto,
  pensjaPotracenia,dodatekPotracenia,
  ...
  begin
   ...
   if pensjaBrutto < 0 then
      ...
      dodatekNetto:=0;
        ...
        pensjaNetto:= pensjaBrutto - TPodatek.ObliczPodatkiMiesiac(pensjaBrutto,pensjaBruttoRok) ;
        dodatekNetto:= dodatekBrutto - TPodatek.ObliczTylkoPodatekMiesiac(dodatekBrutto,pensjaBruttoRok);
        end;
